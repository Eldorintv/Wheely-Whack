...
Texture Texture::LoadCubeMap(const char* front, const char* back, const char* up, const char* down, const char* right, const char* left) {
    Texture texture;
    ...
    texture.createTextureSampler(true);
...
std::vector<stbi_uc*> Texture::loadCubeMapImages(std::vector<const char*>& paths, int& texWidth, int& texHeight, int& texChannels) {
...
void Texture::createTextureImageCubeMap(std::vector<const char*>& paths) {
    int texWidth, texHeight, texChannels;
